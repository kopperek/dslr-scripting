 ...
 */
public class EnableBracketingProperty extends AbstractCameraProperty {

    public EnableBracketingProperty() {
        super("EnableBracketing",DeviceProp.ENABLE_BRACKETING,true,true);
    }
