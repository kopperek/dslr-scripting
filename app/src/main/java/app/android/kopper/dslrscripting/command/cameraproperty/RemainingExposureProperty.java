 ...
 */
public class RemainingExposureProperty extends AbstractCameraProperty {

    public RemainingExposureProperty() {
        super("RemainingExposure",DeviceProp.REMAINING_EXPOSURE,true,false);
    }
