 ...
 */
public class CompressionSettingProperty extends AbstractCameraProperty {
    ...
    public CompressionSettingProperty() {
        super("CompressionSetting",DeviceProp.COMPRESSION_SETTING,true,true);
    }
