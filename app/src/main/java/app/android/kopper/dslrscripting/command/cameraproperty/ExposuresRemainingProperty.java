 ...
 */
public class ExposuresRemainingProperty extends AbstractCameraProperty {

    public ExposuresRemainingProperty() {
        super("ExposuresRemaining",DeviceProp.EXPOSURE_REMAINIG,true,false);
    }

    @Override
    public IConverter getConverter() {
        return new IntegerConverter(new UnsignedConverter(2));
    }
}
