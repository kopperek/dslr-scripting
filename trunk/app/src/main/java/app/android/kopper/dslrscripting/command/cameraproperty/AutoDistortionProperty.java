 ...
 */
public class AutoDistortionProperty extends AbstractCameraProperty {

    public AutoDistortionProperty() {
        super("AutoDistortion",DeviceProp.AUTO_DISTORTION,true,true);
    }
