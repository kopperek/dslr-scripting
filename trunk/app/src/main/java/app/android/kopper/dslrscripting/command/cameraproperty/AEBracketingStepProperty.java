 ...
 */
public class AEBracketingStepProperty extends AbstractCameraProperty {
    ...
    public AEBracketingStepProperty() {
        super("AEBracketingStep",DeviceProp.AEBRACKETING_STEP,true,true);
    }
