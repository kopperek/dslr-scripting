 ...
 */
public class ActiveDLightingProperty extends AbstractCameraProperty {
    ...
    public ActiveDLightingProperty() {
        super("ActiveDLighting",DeviceProp.ACTIVE_D_LIGHTING,true,true);
    }
