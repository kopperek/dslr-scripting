 ...
 */
public class ContinuousShootingCountProperty extends AbstractCameraProperty {

    public ContinuousShootingCountProperty() {
        super("ContinuousShootingCount",DeviceProp.CONTINUOUS_SHOOTING_COUNT,true,false);
    }
